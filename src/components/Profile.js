...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if(username === '' || username === null){
         ...
         fetch(process.env.REACT_APP_API+"/user/" + username).then((res) => {
                return res.json();
            }).then((resp) => {
                //console.log(resp)
                idchange(resp.id);
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <input disabled readOnly value={id} onChange={e => idchange(e.target.value)} className="form-control"></input>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="form-group">
